...
USE_TZ = False  # Логическое значение, указывающее, являются ли datetimes известными часовыми поясами. При создании проекта с командой startproject это значение равно True
