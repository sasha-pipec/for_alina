...
# Author, Book --> тут тоже самое, в файле moedls нету таких моделей
from django.urls import reverse
from rest_framework.status import HTTP_200_OK as OK
from django.contrib.auth.models import User
from django.test.client import Client
from collection_app.config import PAGINATOR_THRESHOLD
...
genre_attrs = {'title': 'genre'}  # --> поле называется title
GenreListViewTest = test_view('/genres/', 'genres', 'collection/genres.html', Genres, genre_attrs)  # -->  у тебя шаблон лежит в папке collection
...
# WeatherPageTest = test_view('/weather/', 'weather', 'pages/weather.html') --> у тебя нету url weather и шаблона тоже
